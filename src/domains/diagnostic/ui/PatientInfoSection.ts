        ...
        ${patientInfo.conditionName || patientInfo.conditionDescription || patientInfo.conditionLocation ? `
          <div class="condition-info" style="margin-bottom: ${spacing.md};">
            ...
            ${patientInfo.conditionDescription ? `
              <div style="font-size: ${typography.fontSize.sm}; color: ${colors.neutral.white}; margin-bottom: ${spacing.xs};">
                <strong style="display: block; color: ${colors.neutral.base}; font-weight: ${typography.fontWeight.normal}; font-size: ${typography.fontSize.xs}; text-transform: uppercase; letter-spacing: ${typography.letterSpacing.wider};">Description</strong>
            ...
            ${patientInfo.conditionLocation ? `
              <div style="font-size: ${typography.fontSize.sm}; color: ${colors.neutral.white}; margin-bottom: ${spacing.xs};">
                <strong style="display: block; color: ${colors.neutral.base}; font-weight: ${typography.fontWeight.normal}; font-size: ${typography.fontSize.xs}; text-transform: uppercase; letter-spacing: ${typography.letterSpacing.wider};">Location</strong>
          ...
          <div class="vital-signs" style="margin-bottom: ${spacing.md};">
            ...
            <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: ${spacing.sm};">
              ${patientInfo.vitalSigns.bloodPressure ? `
                <div style="font-size: ${typography.fontSize.sm}; color: ${colors.neutral.white};">
                  <strong style="display: block; color: ${colors.neutral.base}; font-weight: ${typography.fontWeight.normal}; font-size: ${typography.fontSize.xs}; text-transform: uppercase; letter-spacing: ${typography.letterSpacing.wider};">BP</strong>
                  <span style="display: block; margin-top: ${spacing.xs};">${patientInfo.vitalSigns.bloodPressure}</span>
                </div>
              ` : ''}
              ${patientInfo.vitalSigns.heartRate ? `
                <div style="font-size: ${typography.fontSize.sm}; color: ${colors.neutral.white};">
                  <strong style="display: block; color: ${colors.neutral.base}; font-weight: ${typography.fontWeight.normal}; font-size: ${typography.fontSize.xs}; text-transform: uppercase; letter-spacing: ${typography.letterSpacing.wider};">HR</strong>
              ...
              ${patientInfo.vitalSigns.respiratoryRate ? `
                <div style="font-size: ${typography.fontSize.sm}; color: ${colors.neutral.white};">
                  <strong style="display: block; color: ${colors.neutral.base}; font-weight: ${typography.fontWeight.normal}; font-size: ${typography.fontSize.xs}; text-transform: uppercase; letter-spacing: ${typography.letterSpacing.wider};">RR</strong>
              ...
              ${patientInfo.vitalSigns.temperature ? `
                <div style="font-size: ${typography.fontSize.sm}; color: ${colors.neutral.white};">
                  <strong style="display: block; color: ${colors.neutral.base}; font-weight: ${typography.fontWeight.normal}; font-size: ${typography.fontSize.xs}; text-transform: uppercase; letter-spacing: ${typography.letterSpacing.wider};">Temp</strong>
              ...
              ${patientInfo.vitalSigns.oxygenSaturation ? `
                <div style="font-size: ${typography.fontSize.sm}; color: ${colors.neutral.white};">
                  <strong style="display: block; color: ${colors.neutral.base}; font-weight: ${typography.fontWeight.normal}; font-size: ${typography.fontSize.xs}; text-transform: uppercase; letter-spacing: ${typography.letterSpacing.wider};">O2 Sat</strong>
              ...
              ${patientInfo.vitalSigns.painLevel !== undefined ? `
                <div style="font-size: ${typography.fontSize.sm}; color: ${colors.neutral.white};">
                  <strong style="display: block; color: ${colors.neutral.base}; font-weight: ${typography.fontWeight.normal}; font-size: ${typography.fontSize.xs}; text-transform: uppercase; letter-spacing: ${typography.letterSpacing.wider};">Pain</strong>
